...
![Main Figure](figstartPred_flowchart.png)
...
### Input format
StartPred supports variants in CSV format as input. The input file should contain at least 7 columns in the header as follows. [Sample file](dataest.csv)
